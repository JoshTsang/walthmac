    ...
    class HtmlStructure {
        ...
        public function args($permission) {
            ...
            for($i=0; $i<$count; $i++) {
                ...
                '<span></span></td><td><button class="btn btn-primary" type="button" data-toggle="modal" onClick="javascript:updateArg(\''.
                ('a'.$i).'\')">修改</button></td></tr>'."\n";
            }
            echo '</table>';
        }
        ...
        public function manage($permission) {
            ...
            echo '<div style="margin-top:20px; margin-bottom:20px; margin-left:20px;"><button class="btn btn-primary" type="button" data-toggle="modal">添加</button></div>';
            echo '<table class="table table-striped ">';
            for($i=0; $i<$count; $i++) {
