<?php
    class HtmlStructure {
        ...
        private $args = array(
            ...
            array('name' => '过滤系数','id'=> 'ExtrAlgLen', 'unit' => '个', 'dispPer' => 1, 'setPer' => 2),
            array('name' => '控制系数','id'=> 'ExtrAlgLendis', 'unit' => '个', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => 'P参数','id'=> 'extrpGain', 'unit' => '', 'dispPer' => 1, 'setPer' => 2),
            array('name' => 'I参数 ','id'=> 'extriGain', 'unit' => '', 'dispPer' => 1, 'setPer' => 2),
            array('name' => 'P控制死区','id'=> 'extrDeadBand', 'unit' => '%', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => '挤出量报警上限','id'=> 'WgtPerHWarnUp', 'unit' => '%', 'dispPer' => 1, 'setPer' => 2),
            array('name' => '挤出量报警下限','id'=> 'WgtPerHWarnDw', 'unit' => '%', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => '最小转度','id'=> 'extrMinSpeed', 'unit' => 'RPM', 'dispPer' => 1, 'setPer' => 2),
            array('name' => '最大转速','id'=> 'maxSpdPerMin', 'unit' => 'RPM', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => '零点死区','id'=> 'extrZeroDeadband', 'unit' => 'mv', 'dispPer' => 3, 'setPer' => 3, 'divider' => TRUE),
            array('title' => '牵引机参数', 'dispPer' => 1),
            array('name' => '过滤系数','id'=> 'calFrq', 'unit' => '个', 'dispPer' => 1, 'setPer' => 2),
            array('name' => '控制系数','id'=> 'calFrqdis', 'unit' => '个', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => 'P参数','id'=> 'dragpGain', 'unit' => '', 'dispPer' => 1, 'setPer' => 2),
            array('name' => 'I参数 ','id'=> 'dragiGain', 'unit' => '', 'dispPer' => 1, 'setPer' => 2),
            array('name' => 'P控制死区','id'=> 'dragDeadBand', 'unit' => '%', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => '米重值报警上限','id'=> 'kgPerMeterWarnUp', 'unit' => '%', 'dispPer' => 1, 'setPer' => 2),
            array('name' => '米重值报警下限','id'=> 'kgPerMeterWarnDw', 'unit' => '%', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
            array('name' => '最小牵引速度','id'=> 'dragMinSpeed', 'unit' => 'm/min', 'dispPer' => 1, 'setPer' => 2),
            array('name' => '最大牵引速度','id'=> 'dragHighScope', 'unit' => 'm/min', 'dispPer' => 1, 'setPer' => 2, 'divider' => TRUE),
